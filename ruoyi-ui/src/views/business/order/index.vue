<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="订单经验" prop="orderExperience">
        <el-input
          v-model="queryParams.orderExperience"
          placeholder="请输入订单经验"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单经验" align="center" prop="orderExperience" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="订单经验" prop="orderExperience">
          <el-input v-model="form.orderExperience" placeholder="请输入订单经验" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        orderExperience: [
          { required: true, message: "订单经验不能为空", trigger: "blur" }
        ],
        orderStatus: [
